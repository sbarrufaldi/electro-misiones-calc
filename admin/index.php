...
<body>
    ...
    <img src="../images/logo_cyan.png" alt="Tickets" width="160" height="160"><br><br><style> form { border: 4px solid #1e6d7e; background-color: #99bcdb; border-radius: 42px; text-align: center; color: #fff;}
...
<form name="coop" method="POST" action="login_validar.php<?php if(isset($_REQUEST['pag'])){echo "?pag=" . $_REQUEST['pag'];}?>" id="blur1">
	...
	<div style="text-align: center;color: white;background-color: #1e6d7e;border-radius: 100px;padding: 13px;margin: -1px;">
<h6 style="text-align: center;color: white;background-color: #1e6d7e;border-radius: 100px;padding: 0px;">ADMINISTRACIÓN</h6>
<h5 style="text-align: center;color: white;background-color: #1e6d7e;border-radius: 100px;padding: 0px;margin-top: 10px;">TICKETS</h5></div>
    <br>
