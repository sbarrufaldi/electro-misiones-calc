...
<div class="table-responsive">
      ...
      while($fila = mysqli_fetch_array($resultado)){
		...
		if($fila['activo'] == 1){
			$estado = "<div class='mb-2 mr-2 badge badge-pill badge-info' style='transition: 0.3s;cursor: pointer;width: 70px;' onmouseover='cerrarTicketIn(this)' onmouseout='cerrarTicketOut(this)' onclick='openForm(&quot;$problema&quot;,&quot;$detalle&quot;,&quot;$ticket&quot;)'>Abierto</div>";
		}
		else{
...
<div>
  ...
  <form method="post" action="cerrar_ticket.php" class="form-container" style="margin-bottom: 0;" id="ticketForm" enctype="multipart/form-data">
    ...
    <h2 style="text-align: center;font-size: 18px;font-weight: bold;background-color: #178d44;border-radius: 500px;color: white;padding: 12px;">CERRAR TICKET</h2>
    ...
    <input type="text" id="detalle" name="detalle" readonly="readonly">
	...
	<label><b>Solucionado por: </b><label style="color: lightgray;margin-bottom: 0px;">(opcional)</label></label>

	<div style="display: flex;">
	<label class="container">Alberto Krieger
  	<input type="checkbox" name="personal1" value="Alberto Krieger">
  	<span class="checkmark"></span>
	</label>
	<label class="container">Alexis Brunas
  	<input type="checkbox" name="personal2" value="Alexis Brunas">
  	<span class="checkmark"></span>
	</label>
	</div>
	<div style="display: flex;">
    <label class="container">Adrián Martinez
  	<input type="checkbox" name="personal3" value="Adrián Martinez">
  	<span class="checkmark"></span>
	</label>
	<label class="container">Darío Martinez
  	<input type="checkbox" name="personal4" value="Darío Martinez">
  	<span class="checkmark"></span>
	</label>
	</div>
	<div style="display: flex;">
	<label class="container">Erik Brun
  	<input type="checkbox" name="personal5" value="Erik Brun">
  	<span class="checkmark"></span>
	</label>
	<label class="container">Javier Slobovzien
  	<input type="checkbox" name="personal6" value="Javier Slobovzien">
  	<span class="checkmark"></span>
	</label>
	</div>
	<div style="display: flex;">
    <label class="container">Julio Zakowicz
  	<input type="checkbox" name="personal7" value="Julio Zakowicz">
  	<span class="checkmark"></span>
	</label>
	<label class="container">Milton Díaz
  	<input type="checkbox" name="personal8" value="Milton Díaz">
  	<span class="checkmark"></span>
	</label>
	</div>
	<div style="display: flex;">
	<label class="container">Ramón Vanacor
  	<input type="checkbox" name="personal9" value="Ramón Vanacor">
  	<span class="checkmark"></span>
	</label>
	<label class="container">Sebastián Barrufaldi
  	<input type="checkbox" name="personal10" value="Sebastián Barrufaldi">
  	<span class="checkmark"></span>
	</label>
	</div>
