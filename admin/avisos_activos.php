...
<head>
    ...
    <title>Tickets | Tickets del turno</title>
                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
								...
								<li>
                                    <a href="avisos_activos.php" class="mm-active">
...
<div class="table-responsive">
      ...
      while($fila = mysqli_fetch_array($resultado)){
		...
		if($fila['activo'] == 2){
			$estado = "<div class='mb-2 mr-2 badge badge-pill badge-info' style='transition: 0.3s;cursor: pointer;width: 70px;' onmouseover='cerrarTicketIn(this)' onmouseout='cerrarTicketOut(this)' onclick='openForm(&quot;$problema&quot;,&quot;$detalle&quot;,&quot;$ticket&quot;)'>Activo</div>";
		}
		else{
			$estado = "<div class='mb-2 mr-2 badge badge-pill badge-success' style='transition: 0.3s;cursor: pointer;width: 70px;' onmouseover='verSolucionIn(this)' onmouseout='verSolucionOut(this)' onclick='openSolucion(&quot;$ticket&quot;)'>Cerrado</div>
			<div class='widget-subheading opacity-7' style='margin-top: -5px;'>Por: <b>$usuario</b></div>";
		}
    ?>
                                            <tr>
                                                <td><?php echo $ticket ?>
												<div class="widget-subheading opacity-7">Creado por: <b><?php echo $fila['usuario']; ?></b></div></td>
...
<divEfecto class="form-popup" id="myForm" style="height: 255px;">
<div>
  ...
  <form method="post" action="cerrar_ticket.php" class="form-container" style="margin-bottom: 0;" id="ticketForm" enctype="multipart/form-data">
    ...
    <h2 style="text-align: center;font-size: 18px;font-weight: bold;background-color: #178d44;border-radius: 500px;color: white;padding: 12px;">CERRAR AVISO</h2>
    ...
    <label><b>¿Desea cerrar el aviso?</b></label>

    <input type="text" id="problema" name="problema" readonly="readonly">
	  
	</form>

    <hr style="margin-top: 2px;margin-bottom: 8px;">

    <button class='btn button-style mt-md-0 mt-4' style="height: 50px;color: white;font-size: 15px;font-weight: bold;width: 120px;float: right;background: #178d44;border-radius: 50px;margin-right: 8px;" id="enviarTicket">Cerrar</button>
...
<div class="form-popup" id="myForm2">
  ...
  <div class="form-container" style="margin-bottom: 0;">
	...
	<h2 style="text-align: center;font-size: 18px;font-weight: bold;background-color: #178d44;border-radius: 500px;color: white;padding: 12px;">SOLUCIÓN</h2>
    ...
    <input type="text" name="solucionVer" id="solucionVer" readonly="readonly">
	  
	<hr>
	  
	<label><b>Solucionado por: </b></label>
	  
	<input type="text" name="personalVer" id="personalVer" readonly="readonly">

    <hr>

    <button class='btn button-style mt-md-0 mt-4' onclick="closeSolucion()"  style="height: 50px;color: white;font-size: 15px;font-weight: bold;width: 120px;float: right;background: #178d44;border-radius: 50px;">Aceptar</button>

    <button class='btn button-style mt-md-0 mt-4' type="button" onclick="closeSolucion()" style="float: left;padding: 8px;background: #178d44;border-radius: 50px;"><img src='../images/iconoatras.png' style='height: 33px; cursor: pointer;'></button>
...
document.getElementById("enviarTicket").addEventListener("click", efectoEnviar);
  ...
  function openForm(problema, detalle, ticket) {
...
function efectoAparecer(){
  var div1 = $("divEfecto");
  div1.animate({height: '255px'}, "slow")
}
...
function cerrarTicketIn(x){
	x.className = 'mb-2 mr-2 badge badge-pill badge-danger';
	x.innerHTML = 'CERRAR';
}
...
function verSolucionOut(x){
	x.className = 'mb-2 mr-2 badge badge-pill badge-success';
	x.innerHTML = 'CERRADO';
}
</script>
