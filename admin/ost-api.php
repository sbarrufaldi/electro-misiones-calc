...
$config = array(
        'url'=>'http://192.168.2.9/osticket/api/http.php/tickets.json',  // URL to site.tld/api/tickets.json
		'key'=>'F5CE945907E9391821EDC6994865567E'  // API Key goes here
);
...
$data = array(
	...
	'subject'   =>      $program,  // test subject, aka Issue Summary
	'program'	=>		$program,
    'status' 	=>		$status,  // phone number aka User/Client Phone Number
    'quest' 	=>		$topicq,
	'message'   =>      'Problema: '.$program.'
Detalle: '.$topicq,  // test ticket body, aka Issue Details.
