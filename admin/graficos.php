...
<head>
    ...
    <title>Tickets | Rendimiento</title>
...
<body>
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header" id="blur1" style="filter: blur(0px); transition: all 1s ease 0s;">
      ...
      $resultado = mysqli_query($link, $consulta);
	  $cantidad_tickets = mysqli_num_rows($resultado);
	  $promedio_relativo = ($cantidad_tickets * 120);
	 
      $consulta = "SELECT SUM(TIMESTAMPDIFF(minute, tickets.timestamp, soluciones.timestamp)) AS difMinutos from tickets, soluciones WHERE 1";
      $resultado = mysqli_query($link, $consulta);
      $fila = mysqli_fetch_array($resultado);
	  $difMinutos = $fila['difMinutos'];
	  $promedio = ($difMinutos / $cantidad_tickets);
	  $promedio_relativo2 = (($promedio_relativo * 100) / $promedio);
	  if($promedio_relativo2 > 100) { $promedio_relativo2 = 100; }
	 
    ?>
								
							<div class="row" style="margin-left: -30px;margin-right: -30px;display: none;">
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content">
                                    <div class="widget-content-outer">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left">
                                                <div class="widget-heading">Total de Tickets</div>
                                                <div class="widget-subheading">Total tickets generados</div>
                                            </div>
                                            <div class="widget-content-right">
                                                <div class="widget-numbers text-success"><?php echo $cantidad_tickets; ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content">
                                    <div class="widget-content-outer">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left">
                                                <div class="widget-heading">Tiempo de solución</div>
                                                <div class="widget-subheading">Tiempo promedio</div>
                                            </div>
                                            <div class="widget-content-right">
                                                <div class="widget-numbers text-success"><?php echo intval($promedio); ?> min</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content">
                                    <div class="widget-content-outer">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left">
                                                <div class="widget-heading">Eficiencia</div>
                                                <div class="widget-subheading">Eficiencia de mantenimiento</div>
                                            </div>
                                            <div class="widget-content-right">
                                                <div class="widget-numbers text-success"><?php echo intval($promedio_relativo2); ?>%</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="display: block;">
                                    <div class="mb-3 card">
										<div class="card-body">
                                                <div class="tab-content">
													<h6 style="border-radius: 50px;text-align: center;background-color: #30b464;color: white;padding: 8px;">Problema más comun</h6>
...
<div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tabla1">
                                            ...
                                            <tbody>
												<?php
      $consulta = "SELECT *, COUNT(problema) AS magnitude 
	  				FROM tickets
					WHERE activo < 2
					GROUP BY problema 
    ...
    ?>
                                            <tr>
												...
												<td class="text-center"><?php echo $fila['magnitude'] ?></td>
												<td class="text-center">
                                                    <button type="button" id="PopoverCustomT-1" class="btn btn-primary btn-sm" onClick="openDetalle('<?php echo $fila['problema'] ?>')" style="border-radius: 50px;padding-left: 15px;padding-right: 15px;margin-left: 5px;">Detalles</button>
                                                </td>
                                            </tr>
												<?php } ?>
                                            </tbody>
...
<!-- ##################################### FINAL DE TABLA ##################################### -->
										...
										<div class="mb-3 card">
                                            <div class="card-body">
                                                <div class="tab-content">
													<h6 style="border-radius: 50px;text-align: center;background-color: #30b464;color: white;padding: 8px;">10 problemas más comunes</h6>
                                                    <div class="tab-pane active" id="tab-animated1-0" role="tabpanel">
...
function openDetalle(problema) {
	
  window.location = "graficos_detalle.php?problema=" + problema;
