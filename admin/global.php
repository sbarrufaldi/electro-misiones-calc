    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header" id="blur1" style="filter: blur(0px); transition: all 1s ease 0s;">
        <div class="app-header header-shadow bg-vicious-stance header-text-light">
            <div class="app-header__logo">
                <div style="width: 100%;display: contents;"><img src="../assets/images/logo_white.png" alt="Tickets" width="90" height="55" style="margin-right: 10px;"><h6 style="float: right;margin-top: 8px;margin-right: 14px;color: #d9e2e7;background-color: #1e6d7e;border-radius: 100px;padding: 6px;padding-left: 18px;padding-right: 18px;cursor: default;">Tickets</h6></div>
                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
								...
								<li>
                                    <a href="global.php" class="mm-active">
...
<div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tabla1">
                                            ...
                                            <tbody>
												<?php
      $consulta = "SELECT * FROM `tickets` WHERE activo < 2 ORDER BY timestamp DESC";
      $resultado = mysqli_query($link, $consulta);
      while($fila = mysqli_fetch_array($resultado)){
...
<div class="form-popup" id="myForm2">
  ...
  <div class="form-container" style="margin-bottom: 0;">
	...
	<h2 style="text-align: center;font-size: 18px;font-weight: bold;background-color: #1e6d7e;border-radius: 500px;color: white;padding: 12px;">SOLUCIÓN</h2>
    ...
    <button class='btn button-style mt-md-0 mt-4' onclick="closeSolucion()"  style="height: 50px;color: white;font-size: 15px;font-weight: bold;width: 120px;float: right;background: #1e6d7e;border-radius: 50px;">Aceptar</button>

    <button class='btn button-style mt-md-0 mt-4' type="button" onclick="closeSolucion()" style="float: left;padding: 8px;background: #1e6d7e;border-radius: 50px;"><img src='../images/iconoatras.png' style='height: 33px; cursor: pointer;'></button>
...
<div class="form-popup" id="myForm3">
  ...
  <form method="post" action="retirar.php" class="form-container" style="margin-bottom: 0;">
    ...
    <button class='btn button-style mt-md-0 mt-4'  style="height: 50px;color: white;font-size: 15px;font-weight: bold;width: 120px;float: right;background: #1e6d7e;border-radius: 50px;">Retirar</button>

    <button class='btn button-style mt-md-0 mt-4' type="button" onclick="closeRetirar()" style="float: left;padding: 8px;background: #1e6d7e;border-radius: 50px;"><img src='images/iconoatras.png' style='height: 33px; cursor: pointer;'></button>

    <button class="btn button-style mt-md-0 mt-4 btncerrar" type="button" onclick="closeRetirar()" style="background: #1e6d7e;border-radius: 50px;"><img src="images/iconocruz.png" style="height: 21px; cursor: pointer;"></button>
...
<div class="form-popup" id="myForm4">
  ...
  <form method="post" action="desmarcar.php" class="form-container" style="margin-bottom: 0;">
	...
	<button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="mb-2 mr-2 dropdown-toggle btn btn-info" style="height: 50px;color: white;font-size: 15px;font-weight: bold;width: 220px;float: right;background: #1e6d7e;border-radius: 50px;">Marcar como recibido</button>
    ...
    <input type="number" name="recibidoCantidad" id="recibidoCantidad">
                                                ...
                                                <button class='btn button-style mt-md-0 mt-4'  style="height: 50px;color: white;font-size: 15px;font-weight: bold;width: 120px;float: right;background: #1e6d7e;border-radius: 50px;">Cargar</button>
                                            </div>

    <button class='btn button-style mt-md-0 mt-4' type="button" onclick="closePedido()" style="float: left;padding: 8px;background: #1e6d7e;border-radius: 50px;"><img src='images/iconoatras.png' style='height: 33px; cursor: pointer;'></button>

    <button class="btn button-style mt-md-0 mt-4 btncerrar" type="button" onclick="closePedido()" style="background: #1e6d7e;border-radius: 50px;"><img src="images/iconocruz.png" style="height: 21px; cursor: pointer;"></button>
...
<div class="form-popup" id="myForm5">
  ...
  <form method="post" action="agregar_imagen.php" class="form-container" enctype="multipart/form-data" style="margin-bottom: 0;">
	...
	<input type="submit" name="submit" value="Subir" style="height: 50px;color: white;font-size: 15px;font-weight: bold;width: 220px;float: right;background: #1e6d7e;border-radius: 50px;">

    <button class='btn button-style mt-md-0 mt-4' type="button" onclick="closeSubirImagen()" style="float: left;padding: 8px;background: #1e6d7e;border-radius: 50px;"><img src='images/iconoatras.png' style='height: 33px; cursor: pointer;'></button>

    <button class="btn button-style mt-md-0 mt-4 btncerrar" type="button" onclick="closeSubirImagen()" style="background: #1e6d7e;border-radius: 50px;"><img src="images/iconocruz.png" style="height: 21px; cursor: pointer;"></button>
...
xmlhttp.onreadystatechange = function() {
  if (this.readyState == 4 && this.status == 200) {
    ...
    document.getElementById("solucionVer").innerHTML = myObj.solucion;
  }
};
...
function efectoAparecer(){
  var div1 = $("divEfecto");
  div1.animate({height: '667px'}, "slow")
}
