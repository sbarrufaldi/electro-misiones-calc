...
<body>
                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
								...
								<li class="app-sidebar__heading">Agregar ticket</li>
								<li>
								...
								<li>
                                    <a href="nuevo_aviso.php" class="mm-active">
                                        <i class="metismenu-icon pe-7s-plus"></i>
                                         Nuevo aviso
                                    </a>
                                </li>
    ...
    <h2 style="text-align: center;font-size: 18px;font-weight: bold;background-color: #178d44;border-radius: 500px;color: white;padding: 12px;">Nuevo aviso</h2>
	  
	<input type="text" id="usuario" name="usuario" readonly="readonly" value="<?php echo $_SESSION['usuario'];?>" style="display:none">
												
	<hr style="margin-bottom: 8px;">
    
    <label><b>Aviso a mostrar:</b></label>

    <input type="text" name="aviso" id="aviso">
														
	<hr style="margin-bottom: 12px;margin-top: 8px;">

    <button class='btn button-style mt-md-0 mt-4' style="height: 40px;color: white;font-size: 15px;font-weight: bold;width: 150px;float: right;background: #178d44;border-radius: 50px;margin-right: 8px; id="enviarTicket">Enviar</button>
