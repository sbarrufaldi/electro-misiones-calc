...
<head>
    ...
    <title>Tickets | Nuevo aviso</title>
...
<body>
                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
								<li class="app-sidebar__heading">Reportar un problema</li>
								...
								<li>
                                    <a href="contacto.php" class="mm-active">
	...
	<form method="post" action="agregar_aviso.php" class="form-container" style="margin-bottom: 0;" id="ticketForm" enctype="multipart/form-data">

    <h2 style="text-align: center;font-size: 18px;font-weight: bold;background-color: #0b9cbd;border-radius: 500px;color: white;padding: 12px;">Contacto con el desarrollador</h2>
	  
	<input type="text" id="usuario" name="usuario" readonly="readonly" value="<?php echo $_SESSION['usuario'];?>" style="display:none">
	
	<input type="text" name="pagina" id="pagina" style="display: none" value="Pantalla Principal">
												
	<hr style="margin-bottom: 8px;">
    
    <label><b>Detalle el problema:</b></label>

    <input type="text" name="aviso" id="aviso">
    
    <hr style="margin-bottom: 8px;">
    
    <label><b>Solución sugerida:</b></label>

    <input type="text" name="sugerencia" id="sugerencia">
														
	<hr style="margin-bottom: 12px;margin-top: 8px;">

    <button class='btn button-style mt-md-0 mt-4' style="height: 40px;color: white;font-size: 15px;font-weight: bold;width: 150px;float: right;background: #0b9cbd;border-radius: 50px;margin-right: 8px; id="enviarTicket">Enviar</button>
